...
export const metadata: Metadata = {
  title: 'Sypho CRM — Invoicing for UK Service Businesses',
  description: 'Professional CRM and invoicing for UK service businesses. Create invoices, track payments, manage customers.',
